...
feature "writing a new post" do
  ...
  context "without javascript" do
    scenario "user is shown the post form, submits it, and sees the post", { js: false } do
      visit "/"
  ...
  context "with javascript" do
    scenario "user is shown the post form, submits it, and sees the post", { js: true } do
      visit "/"
      expect(page).to have_content "Share Anything"
      expect(page).to have_content @previous_post.title
